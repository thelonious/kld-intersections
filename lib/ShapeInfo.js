...
export default class ShapeInfo {
    ...
    static arc(properties) {
        validate(ShapeInfo.ARC, properties);
    }

    static quadraticBezier(properties) {
        validate(ShapeInfo.QUADRATIC_BEZIER, properties);
    }

    static cubicBezier(properties) {
        validate(ShapeInfo.CUBIC_BEZIER, properties);
    }

    static circle(properties) {
        validate(ShapeInfo.CIRCLE, properties);
    }

    static ellipse(properties) {
        validate(ShapeInfo.ELLIPSE, properties);
    }

    static line(properties) {
        validate(ShapeInfo.LINE, properties);
    }

    static path(properties) {
        validate(ShapeInfo.PATH, properties);
    }

    static polygon(properties) {
        validate(ShapeInfo.POLYGON, properties);
    }

    static polyline(properties) {
        validate(ShapeInfo.POLYLINE, properties);
    }

    static rectangle(properties) {
        validate(ShapeInfo.RECTANGLE, properties);
    }
...
function validate(shapeType, properties) {
