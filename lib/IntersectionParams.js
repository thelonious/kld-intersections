...
IPTYPE.LINE = { value: 'Line' };
IPTYPE.RECT = { value: 'Rectangle' };
IPTYPE.ROUNDRECT = { value: 'RoundRectangle' };
IPTYPE.CIRCLE = { value: 'Circle' };
IPTYPE.ELLIPSE = { value: 'Ellipse' };
IPTYPE.POLYGON = { value: 'Polygon' };
IPTYPE.POLYLINE = { value: 'Polyline' };
IPTYPE.PATH = { value: 'Path' };
IPTYPE.ARC = { value: 'Arc' };
IPTYPE.BEZIER2 = { value: 'Bezier2' };
IPTYPE.BEZIER3 = { value: 'Bezier3' });
...
IntersectionParams.newShape(type, props) {
...
IntersectionParams.newPath = newPath;
