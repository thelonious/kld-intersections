...
class PathHandler {
    ...
    arcAbs(rx, ry, xAxisRotation, arcFlag, sweepFlag, x, y) {
        if (rx === 0 || ry === 0) {
            this.addShape(this.generator.line(
            ...
            this.addShape(this.generator.arc(...arcParameters));
        }
    ...
    curvetoCubicAbs(x1, y1, x2, y2, x, y) {
        this.addShape(this.generator.cubicBezier(
            this.lastX, this.lastY,
            x1, y1,
            x2, y2,
            x, y
    ...
    curvetoQuadraticAbs(x1, y1, x, y) {
        this.addShape(this.generator.quadraticBezier(
            this.lastX, this.lastY,
            x1, y1,
            x, y
        ));
