 ...
 *  changes (c) 2015 Robert Benko (Quazistax)
 */

(function (global, factory) {
    //// AMD - commented out until all dependencies are wrapped in AMD compatible way
    //if (typeof define === 'function' && define.amd) {
    //    define(['kld/Point2D', 'kld/Vector2D', 'kld/Polynomial', 'kld/IntersectionParams'], factory);
    //} else
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        global.Intersection = factory(Point2D, Vector2D, Polynomial);
    }
}(this, function (Point2D, Vector2D, Polynomial) {
     ...
     *
     *  @author Kevin Lindsay <kevin@kevlindev.com>
