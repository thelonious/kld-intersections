  ...
  function () {
    ...
    _createClass(Intersection, [{
                ...
                try {
                  checkRoots: for (var _iterator4 = xRoots[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    if (0 <= xRoot && xRoot <= 1) {
                      ...
                      try {
                        for (var _iterator5 = yRoots[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                          var yRoot = _step5.value;
        ...
        try {
          for (var _iterator6 = roots[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            ...
            if (xRoots.length > 0 && yRoots.length > 0) {
              ...
              try {
                checkRoots: for (var _iterator7 = xRoots[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                  var xRoot = _step7.value;
                  ...
                  if (0 <= xRoot && xRoot <= 1) {
                    ...
                    try {
                      for (var _iterator8 = yRoots[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                        var yRoot = _step8.value;
        ...
        try {
          for (var _iterator11 = roots[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
            ...
            if (xRoots.length > 0 && yRoots.length > 0) {
              ...
              try {
                checkRoots: for (var _iterator12 = xRoots[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                  var xRoot = _step12.value;
                  ...
                  if (0 <= xRoot && xRoot <= 1) {
                    ...
                    try {
                      for (var _iterator13 = yRoots[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                        var yRoot = _step13.value;
      ...
      value: function intersectBezier3Ellipse(p1, p2, p3, p4, ec, rx, ry) {
        ...
        try {
          for (var _iterator14 = roots[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
            var t = _step14.value;
      ...
      value: function intersectBezier3Line(p1, p2, p3, p4, a1, a2) {
        ...
        try {
          for (var _iterator15 = roots[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
            var t = _step15.value;
      ...
      value: function intersectEllipseEllipse(c1, rx1, ry1, c2, rx2, ry2) {
        ...
        try {
          for (var _iterator16 = yRoots[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
            var yRoot = _step16.value;
            ...
            try {
              for (var _iterator17 = xRoots[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
                var xRoot = _step17.value;
                var tst = (a[0] * xRoot + a[1] * yRoot + a[3]) * xRoot + (a[2] * yRoot + a[4]) * yRoot + a[5];

                if (Math.abs(tst) < norm0) {
                  tst = (b[0] * xRoot + b[1] * yRoot + b[3]) * xRoot + (b[2] * yRoot + b[4]) * yRoot + b[5];
